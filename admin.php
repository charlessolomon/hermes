...
">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="dash.php">
              <i class="ni ni-tv-2 text-primary"></i> Insert
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="dash_j.php">
              <i class="ni ni-planet text-blue"></i> Card details
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="dash_A.php">
              <i class="ni ni-collection text-purple"></i> Accounts
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link active" href="dash_p.php">
              <i class="ni ni-bullet-list-67 text-info"></i> Edit
            </a>
          </li>
          <li class="nav-item">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="dash.php">Cards</a>
        <!-- Form -->
